<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:100:"/Volumes/Data/ZCloudWS/SivaProject/SivaBase/server/public/../application/admin/view/index/index.html";i:1505014770;s:102:"/Volumes/Data/ZCloudWS/SivaProject/SivaBase/server/public/../application/admin/view/public/header.html";i:1492388820;s:102:"/Volumes/Data/ZCloudWS/SivaProject/SivaBase/server/public/../application/admin/view/public/footer.html";i:1504967998;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <p><i class="fa fa-send-o"></i> 官方网站：<a href="http://zcloud.link" target="_blank">http://zcloud.link</a>
                        </p>
                        <p><i class="fa fa-qq"></i> QQ：<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=82008951&amp;site=qq&amp;menu=yes" target="_blank">82008951</a>
                        </p>
                        <p><i class="fa fa-weixin"></i> 微信：<a href="javascript:;">贴二维码</a>
                        </p>
                        <p><i class="fa fa-credit-card"></i> 支付宝：<a href="javascript:;" class="支付宝信息">贴二维码</a>
                        </p>
                    </div>
                </div>
            </div>
