...
class ArticleModel extends Model
{
    ...
    {
        return $this->field('siva_article.*,name')->join('siva_article_cate', 'siva_article.cate_id = siva_article_cate.id')->where($map)->page($Nowpage, $limits)->order('id desc')->select();
    }
