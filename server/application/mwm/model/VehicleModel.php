...
namespace app\mwm\model;
use think\Model;
use think\Db;

class VehicleModel extends Model
{
    protected $name = 'mwm_vehicle';
    ...
    {
        return $this->field('mwm_vehicle.*,id')->join('mwm_vehicle_type', 'mwm_vehicle.type_id = mwm_vehicle_type.id')->where($map)->page($Nowpage, $limits)->order('id desc')->select();
    }
