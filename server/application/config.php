...
return [
    ...
    'auth_config'  => [
        ...
        'auth_group'        => 'siva_auth_group', // 用户组数据不带前缀表名
        'auth_group_access' => 'siva_auth_group_access', // 用户-用户组关系不带前缀表
        'auth_rule'         => 'siva_auth_rule', // 权限规则不带前缀表
        'auth_user'         => 'siva_admin', // 用户信息不带前缀表
    ],
    ...
    // | 验证类型
    // +----------------------------------------------------------------------
    'auth_key' => '0f05ce379df0e130c715065b42720dd1',
    'pages'    => '10',//分页数
